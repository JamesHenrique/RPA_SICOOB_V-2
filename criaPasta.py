...
def dadosConta_RECAP_PNEUS_18198_6():
    numeroDaConta = 'RP_REFORMADORA_18198-6'
    data = todasDatas()[0]
    banco = 'SICOOB'
    return numeroDaConta, data, banco

def dadosConta_RECAP_PNEUS_64957_0():
    numeroDaConta = 'RP_REFORMADORA_64957-0'
    data = todasDatas()[0]
    banco = 'SICOOB'
    return numeroDaConta, data, banco
...
def criaPasta(indice=None):
    ...
    contas = [
        ...
        dadosConta_RECAP_PNEUS_18198_6(),
        dadosConta_RECAP_PNEUS_64957_0()
