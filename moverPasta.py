...
from caminhos import ONE_DRIVE_SALGADARIA, ONE_DRIVE_IMPETUS,ONE_DRIVE_RECAP_PNEUS
...
def criar_caminho_onedrive(cliente):
    ...
    raiz_RECAP_PNEUS = ONE_DRIVE_RECAP_PNEUS
    ...
    if cliente == 'SALGADARIA_3258':
        ...
        nome_pasta = rf'RCP PNEUS LTDA\{mes_ano_atual}\{todasDatas()[0]}_SICOOB_64957-0'
        caminho_base = raiz_RECAP_PNEUS
    
    elif cliente == 'RECAP_PNEUS_4277':
        nome_pasta = rf'RP REFORMADORA DE PNEUS LTDA\{mes_ano_atual}\{todasDatas()[0]}_SICOOB_18198-6'
        caminho_base = raiz_RECAP_PNEUS
