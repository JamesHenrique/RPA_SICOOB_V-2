...
import pyperclip
from acoes import verifica_total_regis_convenio,verifica_btn_prox_pagina,verifica_nenhum_cp_selecionado,verifica_btn_gerar_comprovante,verifica_cabecalho_convenio,verifica_btn_consultar,verifica_btn_salvar,verifica_formato_pdf,verifica_btn_salvar_pdf,verifica_btn_voltar
import os
...
def seleciona_cp_convenio(cliente):
        ...
        while quantidade_comprovantes > 0:
            ...
            while valor > 0:
                 ...
                 posX = posX + 25 #antes 20
                 valor = valor - 1
                 infoLogs().info('clicou: posição x: {} | posição y: {}'.format(posX, posY))
