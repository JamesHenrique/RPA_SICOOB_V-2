...
def iniciar_tela():
    try:
        ...
        def selecionar_todos():
            ...
            var_opcao6.set(novo_estado)
            var_opcao7.set(novo_estado)
        ...
        def obter_valores():
            ...
            if var_opcao6.get():
                valores_selecionados.append("RECAP_PNEUS_4277")
            if var_opcao7.get():
                valores_selecionados.append("RECAP_PNEUS_3214")
        ...
        def atualizar_estado_botao():
            ...
            if var_opcao1.get() or var_opcao2.get() or var_opcao3.get() or var_opcao4.get() or var_opcao5.get() or var_opcao6.get() or var_opcao7.get():
        ...
        var_opcao6 = tk.BooleanVar()
        var_opcao7 = tk.BooleanVar()
        ...
        tk.Checkbutton(janela, text="RECAP PNEUS_4277", variable=var_opcao6, command=atualizar_estado_botao).pack()
        tk.Checkbutton(janela, text="RECAP PNEUS_3214", variable=var_opcao7, command=atualizar_estado_botao).pack()
